...
import com.tikal.mscontrol.mediacomponent.SurfaceComponent;

public class SurfaceComponentImpl extends JoinableContainerImpl implements SurfaceComponent, VideoRx {
	...
	public SurfaceComponentImpl(View surface, int displayWidth,
			int displayHeight) throws MediaControlException {
	...
	@Override
	public void record(View displaySurface, int displayWidth, int displayHeight) {
		isRecording = true;
	}
