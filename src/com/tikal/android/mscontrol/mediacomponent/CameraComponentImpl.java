...
import com.tikal.mscontrol.mediacomponent.CameraComponent;

public class CameraComponentImpl extends JoinableContainerImpl implements CameraComponent, SurfaceHolder.Callback,
		PreviewCallback {
	...
	public CameraComponentImpl(View surface, int width,
			int height) throws MediaControlException {
		this.videoSurfaceTx = surface;
		this.width = width;
		this.height = height;
	}
